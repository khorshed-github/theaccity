...
<head>
    ...
    <style>
        ...
        .footer__social-enhanced a:hover {
            background: var(--brand-red);
            color: #fff;
            transform: translateY(-5px);
            box-shadow: 0 5px 15px rgba(218, 58, 52, 0.4);
            border-color: var(--brand-red);
        }

        .footer__social-enhanced a.fb:hover {
            background: #1877F2;
            border-color: #1877F2;
            box-shadow: 0 5px 15px rgba(24, 119, 242, 0.4);
        }

        .footer__social-enhanced a.ins:hover {
            background: #E4405F;
            border-color: #E4405F;
            box-shadow: 0 5px 15px rgba(228, 64, 95, 0.4);
        }

        .footer__social-enhanced a.tik:hover {
            background: #000000;
            border-color: #000000;
            box-shadow: 0 5px 15px rgba(0, 0, 0, 0.4);
        }

        .footer__social-enhanced a.yt:hover {
            background: #FF0000;
            border-color: #FF0000;
        ...
        /* Breadcrumb Override */
        .breadcrumb__area {
            background-color: rgba(33, 41, 88, 0.85) !important;
            /* Navy Blue overlay fallback */
            border-bottom: 2px solid var(--brand-red);
            position: relative;
        }
    ...
    <script type="application/ld+json">
    {
      ...
      "sameAs": [
        "https://www.facebook.com/profile.php?id=61583977801853#",
        "https://www.instagram.com/accityltd/",
        "https://www.tiktok.com/@accityltd",
        "https://www.youtube.com/@accityltd"
      ]
                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="{{ url('/') }}">
                                <img src="{{ asset($settings['site_logo'] ?? 'web-assets/imgs/logo/theaccity.png') }}"
                                    alt="{{ $settings['site_name'] ?? 'Theaccity' }}">
                            </a>
                        </div>
                    ...
                    <div class="offcanvas__social">
                        ...
                        <ul>
                            <li><a href="https://www.facebook.com/profile.php?id=61583977801853#"><i
                                        class="fab fa-facebook-f"></i></a></li>
                            <li><a href="https://www.instagram.com/accityltd/"><i
                                        class="fa-brands fa-instagram"></i></a></li>
                            <li><a href="https://www.tiktok.com/@accityltd"><i class="fa-brands fa-tiktok"></i></a></li>
                            <li><a href="https://www.youtube.com/@accityltd"><i class="fa-brands fa-youtube"></i></a>
                            </li>
                        </ul>
                    </div>
                    <div class="offcanvas__btn d-sm-none">
                        <div class="header__btn-wrap">
                            <a class="rr-btn btn-hover-white" href="/contact">Contact Us<span><i
                ...
                <div class="container">
                    <div class="footer-top d-flex justify-content-between pt-50 pb-50">
                        <div class="footer-top-left d-flex wow fadeInLeft animated" data-wow-delay=".2s">
                            ...
                            <h3>Need any support for <br> Admission and visa?</h3>
                        </div>
                        <div class="footr-top-right d-flex wow fadeInLeft animated" data-wow-delay=".3s">
                            <div class="footer-top-right d-flex">
                                ...
                                <h3>are you ready for <br> get started?</h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="footer__widget footer__widget-item-1 wow fadeInLeft animated" data-wow-delay=".2s">
                            <span class="footer__widget-item-1-location"><img
                                    src="web-assets/imgs/footer/footer1-bg-location-img.png" alt="img not found"></span>
                            ...
                            <div class="footer__address mt-20" style="color: #fff; font-size: 14px;">
                                <p style="margin-bottom: 5px;"><i class="fa-solid fa-location-dot"
                                        style="color: #DA3A34; margin-right: 8px;"></i> <strong>London Office:</strong>
                                    Room G2-G4, 251-253 Commercial Road, London, E1 2BT</p>
                                <a href="https://www.google.com/maps/search/?api=1&query=251-253+Commercial+Road+London+E1+2BT"
                                    target="_blank"
                                    style="color: #DA3A34; text-decoration: underline; font-size: 13px;">View on Google
                                    Maps</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="footer__widget footer__widget-item-2 footer3__item-2 wow fadeInLeft animated"
                            ...
                            <div class="footer__link">
                                <ul>
                                    <li><a href="uk-home-students"><i class="fa-solid fa-angle-right"></i>UK Home
                                            Students</a></li>
                                    <li><a href="international-recruitment"><i
                                                class="fa-solid fa-angle-right"></i>International Recruitment</a></li>
                                    ...
                                    <li><a href="complaint"><i class="fa-solid fa-check"></i>Complaint</a></li>
                                    <li><a href="legal"><i class="fa-solid fa-check"></i>Legal</a></li>
                                    <li><a href="safe-guarding"><i class="fa-solid fa-check"></i>Safe guarding</a></li>
                                    <li><a href="data-protection"><i class="fa-solid fa-check"></i>Data protection</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="footer__widget footer__widget-item-3 wow fadeInLeft animated mt-md-50 mt-sm-40 mt-xs-35"
                            ...
                            <div class="footer__link">
                                <ul>
                                    ...
                                    <li><a href="university-partners"><i class="fa-solid fa-angle-right"></i>University
                                            Partners</a></li>
                                    ...
                                    <li><a href="career"><i class="fa-solid fa-angle-right"></i>Career</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer__widget footer__widget-item-4 wow fadeInLeft animated mt-md-50 mt-sm-40 mt-xs-35"
                            ...
                            <div class="footer__subscribe subscribe-2">
                                <ul>
                                    <li>
                                        <p> Stay updated with the latest news, updates, and special offers—delivered
                                            straight to your inbox.</p>
                                    </li>
                                </ul>
                                <div class="footer-form">
                                    <!-- Alert container -->
                                    <div class="w-100" id="alertBox" style="display:none; margin-top:10px;"></div>

                                    <form id="subscribeForm" class="rr-subscribe-form">
                                        @csrf
                                    ...
                                    document.getElementById("subscribeForm").addEventListener("submit", function (e) {
                                        ...
                                        fetch("{{ route('subscribe.store') }}", {
                                            ...
                                            .then(data => {
                                                ...
                                                alertBox.innerHTML = `<div class="alert alert-success w-100">${data.message}</div>`;
                                            ...
                                            .catch(async err => {
                                                ...
                                                if (err instanceof Response) {
                                                    ...
                                                    if (json.errors && json.errors.email) {
                                                        errorMsg = json.errors.email[0];
                                                    }
                                                }
                                                alertBox.style.display = "block";
                                                alertBox.innerHTML = `<div class="alert alert-danger w-100">${errorMsg}</div>`;
                                            });
                                    });
                                </script>
                            ...
                            <div class="footer__social-enhanced mt-30 wow fadeInUp animated" data-wow-delay=".6s">
                                <a href="https://www.facebook.com/accityltd" class="fb" target="_blank"
                                    style="text-decoration:none;"><i class="fab fa-facebook-f"></i></a>
                                <a href="https://www.instagram.com/accityltd/" class="ins" target="_blank"
                                    style="text-decoration:none;"><i class="fa-brands fa-instagram"></i></a>
                                <a href="https://www.tiktok.com/@accityltd" class="tik" target="_blank"
                                    style="text-decoration:none;"><i class="fa-brands fa-tiktok"></i></a>
                                <a href="https://www.youtube.com/@accityltd" class="yt" target="_blank"
                                    style="text-decoration:none;"><i class="fa-brands fa-youtube"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer__bottom-wrapper">
                <div class="container">
                    <div class="footer__bottom">
                        ...
                        <div class="footer__copyright wow fadeInLeft animated" data-wow-delay=".6s">
                            <p>Developed By - <a href="http://e-sheba.com/">E-SHEBA</a></p>
                        </div>

                        <div class="footer__copyright-menu">
                            <ul>
                                <li class=" wow fadeInLeft animated" data-wow-delay="1.6s"><a href="#">Trams &
                                        Condition</a></li>
                                <li class=" wow fadeInLeft animated" data-wow-delay="1.8s"><a href="#">Privacy
                                        Policy</a></li>
                                <li class=" wow fadeInLeft animated" data-wow-delay="2s"><a href="contact">Contact
                                        Us</a></li>
                            </ul>
                        </div>
                    </div>
        ...
        $(document).ready(function () {
            ...
            $('#search').on('keyup', function () {
                ...
                $('.course-card').each(function () {
                    let title = $(this).find('.course-title').text().toLowerCase();
                ...
                // Optional: scroll to course list area after typing
                $('html, body').animate({
                    scrollTop: $('#courseListArea').offset().top - 100
                }, 300);
            });



            $(document).on('click', '.university_search', function (e) {
                e.preventDefault();

                $('.university_search, .location_search, .intakes_search').removeClass('active');
                ...
                if (selectedId === 'all') {
                    ...
                    $('.course-card').hide();
                    $('.course-card[data-university="' + selectedId + '"]').show();
                }
            });
            ...
            $(document).on('click', '.location_search', function (e) {
                ...
                if (selectedLocation === 'all') {
                    ...
                    $('.course-card').each(function () {
                        let locations = $(this).attr('data-locations');
                        try {
                            locations = JSON.parse(locations);
                        } catch (e) {
                            locations = [];
                        }
                        if (Array.isArray(locations) && locations.includes(selectedLocation)) {
                            $(this).show();
                        } else {
                            $(this).hide();
                        }
                    ...
                    if ($('.course-card:visible').length === 0) {
                        if ($('#noResults').length === 0) {
                            $('#courseListArea').append('<div id="noResults" class="text-center mt-3 text-muted bg-warning">No courses found</div>');
                        }
                    } else {
                        $('#noResults').remove();
                    }
                ...
                // ✅ Smooth scroll to course list area
                $('html, body').animate({
                    scrollTop: $('#courseListArea').offset().top - 100
                }, 600);
            });

            $(document).on('click', '.intakes_search', function (e) {
                e.preventDefault();

                $('.university_search, .location_search, .intakes_search').removeClass('active');
                $(this).addClass('active');

                let selectedIntake = $(this).data('intake');

                if (selectedIntake === 'all') {
                    $('.course-card').show();
                } else {
                    $('.course-card').each(function () {
                        let intakes = $(this).attr('data-intakes');
                        try {
                        ...
                        if (Array.isArray(intakes) && intakes.includes(selectedIntake)) {
                            $(this).show();
                        } else {
                            $(this).hide();
                        }
