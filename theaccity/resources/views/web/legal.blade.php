                ...
                <div class="col-12">
                    <div class="breadcrumb__content">
                        <div class="breadcrumb__title-wrapper mb-15 mb-sm-10 mb-xs-5">
                            <h1 class="breadcrumb__title color-white wow fadeIn animated" data-wow-delay=".1s">Legal Compliance</h1>
                        </div>
                        <div class="breadcrumb__menu wow fadeIn animated" data-wow-delay=".5s">
                            <nav>
                                <ul>
                                    <li><span><a href="/">Home</a></span></li>
                                    <li class="active"><span>Legal Compliance</span></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="faq-5__thumb">
                        <div class="faq-5__thumb-shape upDown-bottom">
                            <img src="public/web-assets/responsibility/legal.jpg" alt="img not found">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="section__title-wrapper mb-40">
                        <h6 class="section__title-wrapper-black-subtitle mb-10 wow fadeInLeft animated" data-wow-delay=".2s">Legal Compliance</h6>
                        <h2 class="section__title-wrapper-title wow fadeInLeft animated" data-wow-delay=".3s">Upholding Laws and  <br> Regulations</h2>
                    </div>
                    <div class="ask-question__faq">
                        <div class="accordion" id="accordionExample">
                            @foreach($legals as $com)
