...
<head>
    ...
    <meta name="description" content="Theaccity helps students achieve their dream of global education with expert guidance on study abroad, university admission, visa processing, and career opportunities.">
    
    <meta name="keywords" content="Theaccity, Study Abroad, Global Education, University Admission, Student Visa, Overseas Education, Study Consultancy, International Study">
    ...
    <meta property="og:description" content="Get expert guidance for studying abroad, university admissions, and student visas with Theaccity.">
    ...
    <meta name="twitter:description" content="Expert consultancy for global education, university admission, and study abroad opportunities.">
            ...
            <div class="offcanvas__content">
                ...
                <div class="offcanvas__btn d-sm-none">
                    <div class="header__btn-wrap">
                        <a class="rr-btn btn-hover-white" href="/contact">Contact Us<span><i class="fa-regular fa-angle-right"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="footer__widget footer__widget-item-2 footer3__item-2 wow fadeInLeft animated" data-wow-delay=".3s">
                        ...
                        <div class="footer__link">
                            <ul>
                                    ...
                                    <li><a href="data-protection"><i class="fa-solid fa-check"></i>Data protection</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer__widget footer__widget-item-3 wow fadeInLeft animated mt-md-50 mt-sm-40 mt-xs-35" data-wow-delay=".4s">
                        ...
                        <div class="footer__link">
                            <ul>
                                    ...
                                    <li><a href="university-partners"><i class="fa-solid fa-angle-right"></i>University Partners</a></li>
                                    <li><a href="support-a-students"><i class="fa-solid fa-angle-right"></i>Student Support</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__widget footer__widget-item-4 wow fadeInLeft animated mt-md-50 mt-sm-40 mt-xs-35" data-wow-delay=".5s">
                        ...
                        <div class="footer__subscribe subscribe-2">
                            <ul>
                                <li>
                                    <p> Stay updated with the latest news, updates, and special offers—delivered straight to your inbox.</p>
                                </li>
                            </ul>
            ...
            <div class="container">
                <div class="footer__bottom">
                    ...
                    <div class="footer__copyright-menu">
                        <ul>
                            <li class=" wow fadeInLeft animated" data-wow-delay="1.6s"><a href="#">Trams & Condition</a></li>
                            <li class=" wow fadeInLeft animated" data-wow-delay="1.8s"><a href="#">Privacy Policy</a></li>
                            <li class=" wow fadeInLeft animated" data-wow-delay="2s"><a href="contact">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
            </div>
