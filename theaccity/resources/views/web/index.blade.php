                ...
                <div class="row align-items-center justify-content-center text-center">
                    <div class="col-lg-8">
                        ...
                        <div class="wow fadeInUp animated d-flex flex-wrap justify-content-center gap-3"
                            ...
                            <!-- Apply Now (→ student login/registration) -->
                            <a href="student/login"
            ...
            <div class="container">
                <div class="visit__wrapper">
                    ...
                    <div class="visit__wrapper-countries">
                        <div class="section__title-wrapper mb-20">
                            <h6 class="section__title-wrapper-black-subtitle mb-4 wow fadeInLeft animated"
                                data-wow-delay=".2s">Universities You Can Visit</h6>
                            <h2 class="section__title-wrapper-title wow fadeInLeft animated" data-wow-delay=".3s">Select the
                                University of Your Choice</h2>
                        </div>
                        <div class="visit__wrapper-countries-wrap"
                            style="margin-bottom: 10px !important; gap: 20px !important;">
                            @foreach($university as $unv)
                                <div class="visit__wrapper-countries-wrap-box img-1">
                                    <img class="img-fluid" src="{{ asset('assets/images/University/' . $unv->file_name) }}"
                                        alt="{{ $unv['name'] }}">
