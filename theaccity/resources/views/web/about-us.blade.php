...
<main>
                ...
                <div class="col-12">
                    <div class="breadcrumb__content">
                        <div class="breadcrumb__title-wrapper mb-15 mb-sm-10 mb-xs-5">
                            <h1 class="breadcrumb__title color-white wow fadeInLeft animated" data-wow-delay=".2s">About Us</h1>
                        </div>
    ...
    <!--choose-us-section-->
    <section class=" mt-30 mb-30 position-relative overflow-hidden">
                        ...
                        <div class="choose-us__media">
                            ...
                            <div class="choose-us__media-img">
                                <div class="choose-us__text wow fadeInLeft animated" data-wow-delay=".4s">
                                    <h3 class="counter__item-title"><span class="odometer" data-count="15">0</span></h3>
    ...
    <!--contact-section-->
    <section class="contact-us__area border bg-gray section-space-top bottom custom-width overflow-hidden">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="contact-us__title-wrapper">
                        ...
                        <div class="contact-us__form-wrapper white-bg">
