                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Course Details Edit Form</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">                    
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Course Details Edit Form</h5>
                            </div>
                            <hr>     
                             <div class="card mt-4">
                                <div class="card-body">
                             <form id="CourseDetailsForm" method="POST" enctype="multipart/form-data">
                                @csrf <!-- Add CSRF token for security -->
                                    ...
                                    @if($course_details)
                                        <input type="hidden" name="id" id="id" value="{{ $course_details->id }}">
                                    @endif
                                <div class="mb-3">
                                    <label for="menu" class="form-lebel fw-semibold">Country</label>
                                    <select name="country_id" id="country_id" class="form-control country_edit" required>
                                        <option value="">Select</option>
                                        @foreach($country as $m)
                                            <option value="{{ $m->id }}" 
                                                {{ $course_details && $course_details->country_id == $m->id ? 'selected' : '' }}>
                                                {{ $m->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="university_id" id="university_id" class="form-control" required>
                                        ...
                                        <option value="{{$m->id}}" {{ $course_details && $course_details->university_id == $m->id ? 'selected' : '' }}>{{$m->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="subject_id" id="subject_id" class="form-control" required>
                                        ...
                                        <option value="{{$m->id}}" 
                                        {{ $course_details && $course_details->subject_id == $m->id ? 'selected' : '' }}>
                                        {{$m->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="course_id" id="course_id" class="form-control" required>
                                        ...
                                        @foreach($course as $m)
                                        <option value="{{$m->id}}"
                                        {{ $course_details && $course_details->course_id == $m->id ? 'selected' : '' }}>
                                            {{$m->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('January', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('February', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('March', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('April', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('May', $course_details->intake) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="may">May</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="June" id="june" name="intake[]"
                                            {{ is_array($course_details->intake) && in_array('June', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('July', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('August', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('September', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('October', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('November', $course_details->intake) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->intake) && in_array('December', $course_details->intake) ? 'checked' : '' }}>
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="Online" id="Online" name="delivery_mode[]"
                                                {{ is_array($course_details->delivery_mode) && in_array('Online', $course_details->delivery_mode) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Online">Online</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="Blended" id="Blended" name="delivery_mode[]"
                                                {{ is_array($course_details->delivery_mode) && in_array('Blended', $course_details->delivery_mode) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="In-Campus" id="In-Campus" name="delivery_mode[]"
                                                {{ is_array($course_details->delivery_mode) && in_array('In-Campus', $course_details->delivery_mode) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->entry_route) && in_array('Standard', $course_details->entry_route) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="Standard">Standard</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="Non-standard" id="Non-standard" name="entry_route[]"
                                            {{ is_array($course_details->entry_route) && in_array('Non-standard', $course_details->entry_route) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->entry_route) && in_array('Experience', $course_details->entry_route) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->course_duration) && in_array('1', $course_details->course_duration) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->course_duration) && in_array('2', $course_details->course_duration) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->course_duration) && in_array('3', $course_details->course_duration) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->course_duration) && in_array('4', $course_details->course_duration) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->course_duration) && in_array('5', $course_details->course_duration) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            ...
                                            {{ is_array($course_details->course_duration) && in_array('6', $course_details->course_duration) ? 'checked' : '' }}>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" 
                                               ...
                                               value="{{ $course_details->assessment_required ?? '' }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" 
                                               ...
                                               value="{{ $course_details->title ?? '' }}" required
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control shot_desc" name="shot_desc" id="editor5" rows="3" placeholder="Enter Description">{{ $course_details->shot_desc ?? '' }}</textarea>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="requirement" class="form-label fw-semibold">Requirement Standard route Details</label>
                                    <textarea class="form-control requirement" name="requirement" id="editor1" rows="3" placeholder="Enter Requirement Standard route Details">{{ $course_details->requirement ?? '' }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="requirement2" class="form-label fw-semibold">Requirement Non Standard route Details</label>
                                    <textarea class="form-control requirement2" name="requirement2" id="editor6" rows="3" placeholder="Enter Requirement Non Standard route Details">{{ $course_details->requirement2 ?? '' }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="shot_desc" class="form-label fw-semibold">Schedule Details</label>
                                    <textarea class="form-control schedule" name="schedule" id="editor2" rows="3" placeholder="Enter Schedule">{{ $course_details->schedule ?? '' }}</textarea>
                                </div>
                                <div class="mb-3"> 
                                    <label for="shot_desc" class="form-label fw-semibold">Fees Details</label>
                                    <textarea class="form-control fees" name="fees" id="editor3" rows="3" placeholder="Enter Fees">{{ $course_details->fees ?? '' }}</textarea>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div class="border rounded-3 bg-light-subtle overflow-hidden">
                                        <textarea class="form-control border-0 shadow-none bg-transparent p-3 interview" 
                                                  ...
                                                  style="min-height: 150px; resize: vertical;">{{ $course_details->interview ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" 
                                               ...
                                               name="course_link" 
                                               id="course_link" 
                                               value="{{ $course_details->course_link ?? '' }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" 
                                               ...
                                               name="course_link2" 
                                               id="course_link2" 
                                               value="{{ $course_details->course_link2 ?? '' }}"
                                               placeholder="Enter Prospectus download link here...">
                                        </div>
                                </div>
                                <div class="success_msg"></div>
                                <div class="error_msg"></div>
                                <button type="button" class="btn btn-primary mt-3" id="CourseDetailsSaveBtn">Save Update</button>
                            </form>
                            </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    console.log('Edit page JS loaded ✅'); // debug

    const selectedCountryId = $('#country_id').val();
    const selectedLocations = @json($course_details->location_id ?? []);

    if (selectedCountryId) {
        loadLocations(selectedCountryId, selectedLocations);
    }
    ...
    function loadLocations(countryId, selectedLocations = []) {
        $.post('/get_location', {
            id: countryId,
            _token: $('meta[name="csrf-token"]').attr('content')
        }, function (data) {
            console.log('Locations loaded:', data); // debug
            const locationContainer = $('#location_container');
            locationContainer.empty();

            if (data.length > 0) {
                $.each(data, function (key, values) {
                    const isChecked = selectedLocations.includes(values.name) ? 'checked' : '';
                    const checkboxHtml = `
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="${values.name}"
                                id="location_${values.id}" name="location_id[]" ${isChecked}>
                            <label class="form-check-label" for="location_${values.id}">
                                ${values.name}
                            </label>
                        </div>`;
                ...
                locationContainer.append('<p>No Location Set!</p>');
            }
        });
    }
});
