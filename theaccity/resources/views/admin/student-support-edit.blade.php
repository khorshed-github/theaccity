                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Student Support Edit Information</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">                    
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Student Support Edit Information</h5>
                            </div>
                            <hr>                           
                                     <form id="StudentSupportForm" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label for="menu" class="form-lebel">Sub Menu</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="author" class="form-control" value="{{$news->author}}" id="author" placeholder="Enter Author Name">
                                        </div>
                                        <div class="mb-3">
