    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">                    
                    <a href="course" class="btn btn-primary">Course Information</a>                   
                </div>
            </div>
            <!--end breadcrumb-->
            <div class="row">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Course Information</h5>
                            </div>
                            <hr>                           
                                     <form id="CourseForm" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="button" class="btn btn-primary mt-3" id="CourseSaveBtn">Save</button>
                                    </form>
                                    
                                    
                                    <div class="card mt-4">
                                       <div class="card-header bg-primary"> <h3 class="">Course List</h3></div>
                                       <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($course as $slider)
                                            <tr>
                                                <td class="text-truncate">{{ $slider->name }}</td>
                                                <td>{{ $slider->status ? 'Active' : 'Inactive' }}</td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary Course-edit-btn" data-id="{{ $slider->id }}">Edit</button>
                                                    <button class="btn btn-danger btn-sm Course-deleteBtn" data-id="{{$slider->id}}">Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
