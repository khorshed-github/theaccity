    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <a href="addSubmenu" class="btn btn-primary">Add New Submenu</a>
                </div>
            </div>
            <!--end breadcrumb-->
            <h6 class="mb-0 text-uppercase">Submenu Information</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editModalLabel">Edit Submenu Information</h5>
                                                        ...
                                                        <form id="editSubmenuForm" method="POST">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <label for="edit-menuid"
                                                                            class="form-label">Menu</label>
                                                                        <input type="text" class="form-control" readonly
                                                                            id="edit-menuid-{{ $customer->id }}" name="menuid">
                                                                    </div>                                                  
                                                                    
                                                                    <div class="col-md-12">
                                                                        <label for="edit-name"
                                                                            class="form-label">Submenu</label>
                                                                        <textarea class="form-control" id="edit-name-{{ $customer->id }}" name="name" rows="2"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
